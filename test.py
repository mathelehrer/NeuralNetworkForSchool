...
#example for the first training data
# the image is stored as float values 28x28

# i = 11
# training_data[i][0].resize(28,28)
# print(training_data[i][0])
# from matplotlib import pyplot as plt
# plt.imshow(training_data[i][0], interpolation='nearest')
# plt.show()
# # the number label is stored as a vector
# print("label:\n",training_data[i][1])
